  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <Link
          href="/upload"
          className="rounded-full bg-[#a3ff12] px-5 py-3 text-sm font-bold text-black transition hover:bg-[#b7ff45]"
        >
          Start creating
        </Link>
      </nav>
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-2">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="rounded-3xl border border-white/10 bg-black/30 p-8 transition hover:border-[#a3ff12]/30"
                >
